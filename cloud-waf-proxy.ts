...
<div class="container">
  ...
  <div class="subtitle">
    إدارة المواقع المحمية ومراقبة الطلبات والـIPs المحظورة.
  </div>
          ...
          return `
            <tr>
              ...
              <td>
                ...
                <span
                  class="badge badge-temporary countdown"
...
/* ==========================================================
   LIVE BLACKLIST COUNTDOWN
   ========================================================== */

function updateBlacklistCountdowns() {
